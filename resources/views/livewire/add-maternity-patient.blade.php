<div class="modal-body">
    ...
    <div class="tab-content mt-2">
            ...
            <form wire:submit.prevent="addPatient">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="date" max="{{ date('Y-m-d') }}" class="form-control  @error('date') is-invalid @enderror" wire:model.defer="dob" id="dob">
                        @error('date')
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" wire:model="visitPurpose" id="purpose">
                            ...
                            <option value="Post Partum Care">Post Partum Care</option>
                            <option value="Post Natal Care">Post Natal Care</option>
                            <option value="other">Other</option>
                        </select>
                        @if ($visitPurpose == 'other')
                        <div class="mt-2">
                            <input type="text" class="form-control" wire:model.defer="otherVisitPurpose" id="purpose-other" placeholder="Enter Purpose of Visit">
                        </div>
                        @else
                        &nbsp;
                        @endif
        ...
        <div class="tab-pane fade {{ $currentStage == 2 ? 'show active' : '' }}" id="payment-methods" role="tabpanel">
            ...
            <form wire:submit.prevent="addMedicalAid">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" wire:model.defer="medicalAidSuffix" id="medical-aid-suffix">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="medical-aid-member-name">Member Name</label>
                        <input type="text" class="form-control" wire:model.defer="medicalAidMemberName" id="medical-aid-member-name">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="medical-aid-policy-number">Policy Number</label>
                        <input type="text" class="form-control" wire:model.defer="medicalAidPolicyNumber" id="medical-aid-policy-number">
                    </div>
                    @endif
                </div>
                @endif
            ...
            <form wire:submit.prevent="addGuarantor">
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" wire:model.defer="guarantorName" id="guarantor_name">
                    ...
                    <div class="form-group col-md-4">
                        <label for="surname">Surname</label>
                        <input type="surname" class="form-control" wire:model.defer="guarantorSurname" id="surname">
                        @error('surname')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" wire:model.defer="guarantorNationalId" id="national_id">
                        @error('national_id')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" wire:model.defer="guarantorRelationship" id="relationship">
                        @error('relationship')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <form wire:submit.prevent="addNextOfKin" class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" wire:model.defer="kinName" id="next_of_keen_name">
                        @error('kinName')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" wire:model.defer="kinSurname" id="next_of_keen_surname">
                        @error('kinSurname')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" wire:model.defer="kinPhone" id="next_of_keen_phone">
                        @error('kinPhone')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" wire:model.defer="kinNationalId" id="next_of_keen_national_id">
                        @error('kinNationalId')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" wire:model.defer="kinRelation" id="next_of_keen_relationship">
                        @error('kinRelation')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" wire:model.defer="kinAddress" id="next_of_keen_address"></textarea>
                        @error('kinAddress')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
    ...
    <div class="modal-footer">
        ...
        @if ($currentStage < 4) <button type="submit" class="btn btn-primary" wire:click="nextStage">Next</button>
