<div>
    <div class="row">
        <div class="col-md-3">
            ...
            @if ($admitedTo == $wards->where('name', 'Maternity')->first()->id)
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" id="prenatal_care_provider" name="prenatal_care_provider"
                        class="form-control">
                </div>
            @elseif ($admitedTo == $wards->where('name', 'ICU')->first()->id)
                <div class="col-md-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="reason" name="reason_for_admission" class="form-control"
                        placeholder="e.g Accident Victim/ Transfer Patient">
                </div>
            @elseif ($admitedTo == $wards->where('name', 'Theatre')->first()->id)
                <div class="col-md-3">
