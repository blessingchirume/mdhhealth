            ...
            <div class="col-md-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h3>PostNatal Care <span class="float-right"><a href="{{ route('maternity.index') }}" class="btn btn-primary">Back</a></span></h3>
                    </div>
                    <div class="card-body">
                ...
                <section class="content">
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="icd-10-codes-tab" data-toggle="pill" href="#icd-10-codes" role="tab" aria-controls="icd-10-codes" aria-selected="false">P
                            NC Examination</a>
                        </li>
                    ...
                    <div class="tab-content" id="custom-content-below-tabContent">
                        <div class="tab-pane fade show active" id="icd-10-codes" role="tabpanel" aria-labelledby="icd-10-codes-tab">
                            <!-- ICD-10 Codes Form -->
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">PNC Examination</h5>
                                </div>
                                <div class="card-body">
                                    <form method="post" action="{{ route('create-patient-notes', $episode) }}">
                                        @csrf
                                        @livewire('maternity-observation-form')
