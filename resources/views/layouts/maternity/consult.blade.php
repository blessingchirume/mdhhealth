            ...
            <div class="col-md-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h3>patient Information<span class="float-right"><a href="{{ route('maternity.index') }}" class="btn btn-primary">Back</a></span></h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                ...
                <section class="content">
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="observation-tab" data-toggle="pill" href="#observation" role="tab" aria-controls="observation" aria-selected="true">Observation</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="icd-10-codes-tab" data-toggle="pill" href="#icd-10-codes" role="tab" aria-controls="icd-10-codes" aria-selected="false">ICD-10 Codes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="treatment-plan-tab" data-toggle="pill" href="#treatment-plan" role="tab" aria-controls="treatment-plan" aria-selected="false">Treatment Plan</a>
                        </li>
                        <li class="nav-item">
