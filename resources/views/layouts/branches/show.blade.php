            ...
            <div class="col-lg-12">
                ...
                <section class="content">
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" id="custom-content-below-home-tab" data-toggle="pill" href="#patients" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Patients</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="inventory-tab" data-toggle="pill" href="#inventory" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Inventory</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" id="asset-register-tab" data-toggle="pill" href="#custom-content-below-home" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Asset register</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="custom-content-below-tabContent">
                        <div class="tab-pane fade" id="patients" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                            <div class="card">
                        ...
                        <div class="tab-pane fade" id="inventory" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                            <div class="card">
                                <div class="card-header">
                                    <div class="float-right btn-group btn-group-sm">
                                        <button data-toggle="modal" data-target="#pump-reading" type="button" class="btn btn-primary">
