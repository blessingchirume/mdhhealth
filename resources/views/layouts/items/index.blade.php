                                        ...
                                        <center>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a href="" class="dropdown-item edit-item-btn text-primary"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                    <li><a href="" class="dropdown-item edit-item-btn text-primary"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Add Employee</a></li>
                                                    <li>
