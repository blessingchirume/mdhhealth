            ...
            <div class="col-lg-8">
                ...
                <section class="content">
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="custom-content-below-messages-tab" data-toggle="pill" href="#custom-content-below-messages" role="tab" aria-controls="custom-content-below-messages" aria-selected="false">&nbsp;</a>
                        </li>
                        ...
                        <table class="table table-striped">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $icuadmission->created_at->format('d/m/Y') }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
