        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#administerTreatmentModal">
                    ...
                    <div class="modal fade" id="administerTreatmentModal" tabindex="-1" role="dialog" aria-labelledby="administerTreatmentModalLabel" aria-hidden="true">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <select type="text" class="form-control" id="treatment" name="treatment" required>
                                                        @foreach ($treatments as $index => $value)
