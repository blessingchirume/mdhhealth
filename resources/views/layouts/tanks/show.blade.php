...
<section class="content">
    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#custom-content-below-profile" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Pumps</a>
        </li>
        <li class="nav-item">
    ...
    <div class="tab-content" id="custom-content-below-tabContent">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right btn-group btn-group-sm">
                        <button data-toggle="modal" data-target="#tank-reading" type="button" class="btn btn-primary">
        ...
        <div class="tab-pane fade" id="custom-content-below-profile" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right btn-group btn-group-sm">
                        <button data-toggle="modal" data-target=".bs-example-modal-lg" type="button" class="btn btn-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input value="EXPT0001" class="form-control" name="purchase" type="text" placeholder="Tank Name" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<div class="modal lg fade" id="tank-reading">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tank Reading</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="reading_number" type="text" placeholder="Reading Number" value="EXPT0001" readonly required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
