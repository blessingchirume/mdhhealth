...
<div class="card-body login-card-body">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="input-group mb-3">
            <input type="text" name="surname" class="form-control @error('surname') is-invalid @enderror" placeholder="{{ __('Surname') }}" required autocomplete="surname" autofocus>
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-user"></span>
                </div>
        ...
        <div class="input-group mb-3">
            <select name="role" class="multiple form-control @error('role') is-invalid @enderror" style="padding: 6px 12px !important; width: 100% !important">
                <option value="1" selected="selected">System Admin</option>
                <option value="2" selected="selected">System User</option>
            </select>
